...
<head>
    ...
    <title>HYBE Bootstrap Template - Index</title>
...
<body>
    ...
    <header id="header" class="fixed-top ">
        <div class="container d-flex align-items-center justify-content-lg-between">
            ...
            <h1 class="logo me-auto me-lg-0"><a href="index.html">HYBE<span>.</span></a></h1>
            ...
            <nav id="navbar" class="navbar order-last order-lg-0">
                <ul>
                    ...
                    <li><a class="nav-link scrollto" href="#employee">Employee</a></li>
        ...
        <div class="container" data-aos="fade-up">
            ...
            <div class="row justify-content-center" data-aos="fade-up" data-aos-delay="150">
                <div class="col-xl-6 col-lg-8">
                    <h1>BigHit Compaany<span>.</span></h1>
                </div>
            </div>
    ...
    <main id="main">
            ...
            <div class="container" data-aos="fade-up">
                ...
                <div class="row">
                    <div class="image col-lg-6"
                        style='background-image: url("{{ asset('assets/img/features.jpg') }}");'
        ...
        <section id="ceo" class="ceo">
            <div class="container" data-aos="fade-up">
                ...
                <div class="row">
                        ...
                        <div class="col-lg-3 col-md-6 d-flex align-items-stretch">
                            <div class="member" data-aos="fade-up" data-aos-delay="100">
                                <div class="member-img">
                                    <img src="{{ asset($c->foto) }}" class="img-fluid" alt="">
                                    <div class="social">
                    ...
                    @empty
                        <div class="col md-12">
                            <div class="alert alert-warning">Belum ada CEO disini</div>
                        </div>
                    @endforelse
        ...
        <!-- ======= Team Section ======= -->
        <section id="employee" class="ceo">
            <div class="container" data-aos="fade-up">

                <div class="section-title">
                    <h2>employee</h2>
                    <p>Check our Employee</p>
                </div>
                ...
                <div class="row">
                    ...
                    @forelse ($employee as $e)
                        <div class="col-lg-3 col-md-6 d-flex align-items-stretch">
                            <div class="member" data-aos="fade-up" data-aos-delay="100">
                                <div class="member-img">
                                    <img src="{{ asset($e->foto) }}" class="img-fluid" alt="">
                                    <div class="social">
                                        <a href=""><i class="bi bi-twitter"></i></a>
                                        <a href=""><i class="bi bi-facebook"></i></a>
                                        <a href=""><i class="bi bi-instagram"></i></a>
