...
<body class="app flex-row align-items-center" style="
    background: url({{ asset('assets/img/hero-bg.jpg') }});
">
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-6">
                <div class="card mx-4" style="box-shadow: 1px 1px 4px 2px #edb893;">
                    <div class="card-body p-4">
                        <form method="post" action="{{ url('/register') }}">
                            ...
                            <button type="submit" class="btn btn-dark btn-block btn-flat">Register</button>
